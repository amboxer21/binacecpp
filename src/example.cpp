...
int main() {
  ...
  std::string default_api_key("api key");
  std::string default_secret_key("secret key");

  if(api_key.compare(default_api_key)) {
      cout << "Please export API_KEY!" << endl;
      return 0;
  }
  if(secret_key.compare(default_secret_key)) {
      cout << "Please export SECRET_KEY!" << endl;
      return 0;
  }
